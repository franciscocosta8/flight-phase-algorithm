...
%   distNM = getWakeSepDistance(catLead,catFollow)
%   Inputs:
%     catLead   – string, one of lookupWakeCat outputs
%     catFollow – string, one of lookupWakeCat outputs
%   Output:
%     distNM – numeric, separation in nautical miles
